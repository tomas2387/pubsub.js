(function () {
    ...
    test("Method: subscribeOnce test (with param)", function () {
        ...
        ok(iterator === 1, 'Subscription executed only once');
    });
    ...
    test("Inheritance test (Depth)", function () {
        ...
        var subscription1 = instance.subscribe('hello/world', function (param1) {
    ...
    test("Multiple subscription2 (many namespaces, one callback)", function () {
        ...
        pubsub.publish('hello/world');
        ok(number === 1, 'Subscription to hello/world before unsubscribe is working properly');
        pubsub.publish('goodbye/world');
        ok(number === 2, 'Subscription to goodbye/world before unsubscribe is working properly');
        pubsub.unsubscribe(subscription);

        pubsub.publish('hello/world');
        ok(number === 2, 'Subscription to hello/world after unsubscribe is working properly');
        pubsub.publish('goodbye/world');
        ok(number === 2, 'Subscription to goodbye/world after unsubscribe is working properly');
    });
    ...
    test("Multiple subscription3 (many namespaces, many callbacks)", function () {
        ...
        pubsub.publish('hello/world');
        ok(number1 === 1, 'Subscription to hello/world before unsubscribe is working properly (number1)');
        ok(number2 === 2, 'Subscription to hello/world before unsubscribe is working properly (number2)');
        pubsub.publish('goodbye/world');
        ok(number1 === 2, 'Subscription to goodbye/world before unsubscribe is working properly (number1)');
        ok(number2 === 4, 'Subscription to goodbye/world before unsubscribe is working properly (number2)');
        pubsub.unsubscribe(subscription);

        pubsub.publish('hello/world');
        ok(number1 === 2, 'Subscription to hello/world after unsubscribe is working properly (number1)');
        ok(number2 === 4, 'Subscription to hello/world after unsubscribe is working properly (number2)');
        pubsub.publish('goodbye/world');
        ok(number1 === 2, 'Subscription to goodbye/world after unsubscribe is working properly (number1)');
        ok(number2 === 4, 'Subscription to goodbye/world after unsubscribe is working properly (number2)');
    });
    ...
    test("Pubsub newInstance with own namespaces scope", function () {
        ...
        var privateSubscription = privatePubsub.subscribe('hello/world', function () {
            number2++;
        });
        pubsub.publish('hello/world');
        ...
        privatePubsub.unsubscribe(privateSubscription);
        privatePubsub.publish('hello/world');
    ...
    test("Unsubscribe test string (advanced)", function () {
        ...
        pubsub.subscribe('hello/great/world5', function () {
            values = {
                'param1': 'world5',
                'param2': 'world5'
            };
    ...
    test("Multiple subscription3 un-subscribe string (many namespaces, many callbacks)", function () {
        var number1 = 0;
        var number2 = 0;
    ...
    test("Multiple subscription2 string unsubscription (many namespaces, one callback)", function () {
        var number = 0;
